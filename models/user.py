...
class User(Base):
    ...
    def __init__(self, email:str, password:str, username:str, birthday:date,  sex:int) -> None:
        self.email = email
    ...
    def __repr__(self) -> str:
        return f"User(id={self.id}, email={self.email}, password={self.password}, name={self.username}, birthday={self.birthday}, sex={self.sex})"
